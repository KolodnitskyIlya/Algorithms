...
list_tunnel = [[] for _ in range(N)]

for i in range(M):
    tunnel_1, tunnel_2 = map(int, input().split())
    list_tunnel[tunnel_1 - 1].append(tunnel_2)
    list_tunnel[tunnel_2 - 1].append(tunnel_1)

for i in range(N):
    print(len(list_tunnel[i]), end=' ')
